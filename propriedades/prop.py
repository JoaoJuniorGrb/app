...
if applicativo == "Final":
    ...
    arqivo_css = app/propriedades/styles/main.css
    arqivo_pdf = app/propriedades/assets/Curriculo.pdfpropriedades/assets/Curriculo.pdf
    arqivo_img = app/propriedades/assets/foto_.jpg
